	...
	<div class="container">	
		...
		<form method="post" id="formDetail">
			...
			<div class="row" style="border-bottom:1px solid #C8CACC;"> 
				...
				<div class="col-md-10 fontH">
					<input type="text" class="form-control" id="convenience" name="convenience" style="background-color:white; border-width:0px;" value="${camp.convenience}"readonly>
				</div>
			</div>
			...
			<div class="row" style="border-bottom:1px solid #C8CACC;"> 
				...
				<div class="col-md-10 fontH">
					<input type="text" class="form-control" id="safety" name="safety" style="background-color:white; border-width:0px;" value="${camp.safety}"readonly>
				</div>
			</div>
			...
			<div class="row" style="border-bottom:1px solid #C8CACC;"> 
				...
				<div class="col-md-10 fontH">
					<input type="text" class="form-control" id="etc" name="etc" style="background-color:white; border-width:0px;" value="${camp.etc}"readonly>
				</div>
			</div>
			...
			<div class="row" style="border-bottom:1px solid #C8CACC;"> 
				...
				<div class="col-md-10 fontH">
					<input type="text" class="form-control" id="time" name="time" style="background-color:white; border-width:0px;" value="${camp.time}"readonly>
				</div>
			</div>
			...
			<div class="row" style="border-bottom:1px solid #C8CACC;"> 
				...
				<div class="col-md-10 fontH">
					<input type="text" class="form-control" id="charge" name="charge" style="background-color:white; border-width:0px;" value="${camp.charge}"readonly>
				</div>
			</div>
			...
			<div style="text-align:center; ">			
				<a href="/camping/mycamp/list"><button type="button" class="btn11 btn-primary11 fontH">목록</button></a>		
				<a href="/camping/mycamp/modify?no=${camp.no}"> 
		       		<button type="button" class="btn11 btn-primary11 fontH" style="margin-left:10px">정보수정</button>
		        </a>	
			</div>
		</form>
