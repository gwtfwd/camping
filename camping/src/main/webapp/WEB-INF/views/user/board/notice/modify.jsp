	...
	<div class="container" style="height:880px">	
		...
		<div class="row"> 
			...
			<div class="col-md-7 fontH">
				<input type="text" class="form-control" id="no" name="no" style="background-color:white;" value="${notice.no}" disabled>
			</div>
		...
		<div class="row"> 
			...
			<div class="col-md-7 fontH">
				<input type="text" class="form-control" id="subject" name="subject" style="background-color:white;"  value="${notice.subject}">
			</div>
		...
		<div class="row"> 
			...
			<div class="col-md-7 fontH">
				<input type="text" class="form-control" id="name" name="name" style="background-color:white;" value="${notice.name}" disabled>
			</div>
		...
		<div class="row"> 
			...
			<div class="col-md-7 fontH">
				<textarea rows="8" cols="79" id="contents" name="contents" style="background-color:white; border-radius: 4px; border: 1px solid #ced4da;" >${notice.contents}</textarea>
			</div>
